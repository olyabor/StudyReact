const Phone = (props) => <a href='tel:888'>+7(962)556-1234</a>;
...
const FeaturesSliderItem = (props) => (
  <div className='features-slider_item'>
    <div
      ...
      style={props.style}
    ></div>
    <div className='features-feature'>{props.number} целевое преимущество</div>
  </div>
);

const one = {backgroundImage: "url(./images/1.svg)"};
const two = {backgroundImage: 'url(./images/2.svg)'};
const three = {backgroundImage: 'url(./images/3.svg)'};
const four = {backgroundImage: 'url(./images/4.svg)'};
